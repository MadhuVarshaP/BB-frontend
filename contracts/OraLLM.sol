...
contract ORALLM is AIOracleCallbackReceiver {
    ...
    function calculateAIResult(uint256 modelId, string calldata prompt) payable external {
        ...
        string memory instruction = "From the given Round details and projects applied answer to the questions asked.";
        string memory fullPrompt = string(abi.encodePacked(prompt, " ", instruction));
